...
def editRestaurant(restaurant_name):
    ...
    if editedRestaurant.user_id != login_session['user_id']:
        return """<script>function myFunction() {alert('You can't edit this');}
...
def deleteRestaurant(restaurant_name):
    ...
    if restaurantToDelete.user_id != login_session['user_id']:
        return """<script>function myFunction() {alert('You are not authorized
                to edit this restaurant. Please create your own
...
def showMenu(restaurant_name):
    ...
    if 'username' not in login_session:
        ...
        return render_template('otherMenu.html', items=items,
                               creator=creator,
                               restaurant=restaurant)
    else:
...
# Edit a menu Item
@app.route('/restaurant/<restaurant_name>/menu/<menu_name>/edit',
           methods=['GET', 'POST'])
...
# delete a menu
@app.route('/restaurant/<restaurant_name>/menu/<menu_name>/delete',
           methods=['GET', 'POST'])
...
# JSON Api for Restaurant's Menu
